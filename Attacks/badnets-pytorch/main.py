...
parser.add_argument('--data_path', default='../../Datasets/', help='Place to load dataset (default: ./dataset/)')
...
parser.add_argument('--trigger_label', type=int, default=1, help='The NO. of trigger label (int, range from 0 to 10, default: 1)')
