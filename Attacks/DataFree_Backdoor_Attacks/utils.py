...
def get_data(args):
    ...
    if args.dataset == "imagenet":
        ...
        train_data = dsets.CIFAR10(root=args.dataset_dir, train=True, download=False, transform=transform)
        test_data = dsets.CIFAR10(root=args.dataset_dir, train=False, download=False, transform=transform)
        num_classes = 10
        ...
        train_data = dsets.MNIST(root=args.dataset_dir, train=True, transform=transform, download=False)
        test_data = dsets.MNIST(root=args.dataset_dir, train=False, transform=transform, download=False)
        num_classes = 10
